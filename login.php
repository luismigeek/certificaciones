...
<head>
	<title>Bienvenido | Sistema de Certificaciones para Comunidades Indigenas</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="form_login">
					...
					<center>
						<strong>
							<div id="msg_login" style="color:red">
				...
				<div class="login100-more" style="background-image: url('imagenes/fondo_principal.jpg');">
				</div>
			</div>
		</div>
	</div>
